...
description: |
  View the PDF version using this [link](https://github.com/adolit/VAPG3/blob/master/03_paper/VApaper.pdf)
  
preview: img/paper/overview.png
author:
...
![Most popular locations by no. of credit card transactions](img/paper/bar.png)
...
![Transaction values by location](img/paper/bPlot_cc.png)
...
![Most popular location by day of the week](img/paper/hMday.png)
...
![Vehicle path and POIs](img/paper/poi.JPG)
...
![GASTech organisation tree](img/paper/official_relationships.png)
...
![Unofficial relationships](img/paper/unofficial_relationships.png)
...
![Katerina’s Café Popularity](img/paper/eda_insights_01.png)
...
![Frydos Autosupply n’ More Outliers](img/paper/eda_insights_03.png)
...
![Executives'Lifestyle](img/paper/plk_insights_05.png)
...
![Big Dinner Party](img/paper/plk_insights_06.png)
...
![Truck Driver Community](img/paper/rn_insights_07.png)
...
![Meet up at Chostus Hotel](img/paper/rn_insights_08.png)
