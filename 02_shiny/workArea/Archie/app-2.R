...
ui <- navbarPage("V-ASK App",
                 ...
                 tabPanel("Spending", icon = icon("comment-dollar"),
                          fluidPage(
                              tabsetPanel(
                 ...
                 #ke ----
                 navbarMenu("Kinematics", icon = icon("route"),
                 ...
                 tabPanel("Anomalies", icon = icon("exclamation-triangle"),
                     fluidPage(
                         tabsetPanel(                         
                 ...
                 #
                 navbarMenu("Relationship", icon = icon("people-arrows"),
