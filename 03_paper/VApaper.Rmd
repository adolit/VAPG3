...
Under the ‘Credit Card Data’ tab, we first display an overview bar chart of ‘Most Popular Locations by Frequency’ of credit card transactions. The tooltip of each bar will indicate the number of credit card transactions that took place at each location.
